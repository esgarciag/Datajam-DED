...
1. Poblacion (adulta y/o mayor) por barrio, con su clave y localidad
   -> CSVUsados/Generados/PoblacionAdulta/PoblacionAdultaBarrioNormalizado.csv
...
2. Porcentaje de sedentarismo por localidad (Encuesta Multiproposito 2021)
   -> CSVUsados/Descargados/EncuestaMultiproposito2021ActividadFisica.csv
...
Los resultados (CSV) se guardan en la misma carpeta de la poblacion usada:

CSVUsados/Generados/PoblacionAdulta/indice_prioridad_adulta.csv
CSVUsados/Generados/PoblacionMayor/indice_prioridad_mayor.csv
...
CARPETA_GENERADOS = CARPETA_PROYECTO / "CSVUsados" / "Generados"
...
def ejecutar(config: dict):
    ...
    ruta_png = carpeta_salida / config["salida_png"]
