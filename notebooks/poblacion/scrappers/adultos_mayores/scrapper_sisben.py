...
# .../notebooks/poblacion/scrappers/adultos_mayores/scrapper_sisben.py
CARPETA_CODIGOS = Path(__file__).resolve().parent

# Raiz del repositorio:
# adultos_mayores < scrappers < poblacion < notebooks < raiz
...
CARPETA_DESCARGAS = RAIZ / "data" / "raw" / "sisben" / "adultos_mayores"

# Tabla consolidada de adultos mayores por barrio, que consumen los demas analisis.
CARPETA_SALIDA = RAIZ / "data" / "processed" / "poblacion_mayor"
