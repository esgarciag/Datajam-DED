...
# notebooks/poblacion/scrappers/adultos_mayores/
CARPETA_CODIGOS = Path(__file__).resolve().parent

# Raíz del repositorio:
# adultos_mayores < scrappers < poblacion < notebooks < raíz
RAIZ = CARPETA_CODIGOS.parents[3]

# CSV generados por el scraper
CARPETA_POBLACION_MAYOR = RAIZ / "data" / "processed" / "poblacion_mayor"
